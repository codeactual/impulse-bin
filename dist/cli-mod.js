...
require.register("cmdr-input/index.js", Function("exports, require, module",
"/**\n * commander.js input handling class\n *\n * Licensed under MIT.\n * Copyright (c) 2013 David Smith <https://github.com/codeactual/>\n */\n\n/*jshint node:true*/\n'use strict';\n\nmodule.exports = {\n  CmdrInput: CmdrInput,\n  require: require // Allow tests to use component-land require.\n};\n\nvar configurable = require('configurable.js');\n\nfunction CmdrInput() {\n  this.settings = {\n    nativeRequire: {}\n  };\n}\n\nconfigurable(CmdrInput.prototype);\n\nCmdrInput.prototype.run = function(input, cb) {\n  var rsvp = this.get('nativeRequire')('rsvp');\n  var promise = new rsvp.Promise();\n  cb.call(this, input, promise);\n  return promise;\n};\n\nCmdrInput.prototype.exit = function(msg, code) {\n  this.get('nativeRequire')('util').error(msg);\n  process.exit(typeof code === 'undefined' ? 1 : code);\n};\n\nCmdrInput.prototype.exitOnShellError = function(res) {\n  if (res.code !== 0) { this.exit(res.output, res.code); }\n};\n\nCmdrInput.prototype.exitOnMissingParam = function(input, params) {\n  var self = this;\n  params.forEach(function(param) {\n    if (!input[param]) { self.exit('--' + param + ' required'); }\n  });\n};\n//@ sourceURL=cmdr-input/index.js"
));
require.alias("visionmedia-configurable.js/index.js", "cmdr-input/deps/configurable.js/index.js");

require.alias("codeactual-sinon-doublist/index.js", "cmdr-input/deps/sinon-doublist/index.js");
...
if (typeof exports == "object") {
  module.exports = require("cmdr-input");
} else if (typeof define == "function" && define.amd) {
  define(function(){ return require("cmdr-input"); });
} else {
  window["CmdrInput"] = require("cmdr-input");
}})();